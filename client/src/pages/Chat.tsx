...
import GroupChatCard from '../components/group/GroupChatCard';
import GroupConversationCard from '../components/group/GroupConversationCard';
import DummyChatCard from '../components/helpers/DummyChatCard';
import Loading from '../components/helpers/Loading';
import ConversationCard from '../components/private/ConversationCard';
...
export default function Chat() {
    ...
    return (
        <div className={`w-full  min-h-screen ${theme === 'on' ? 'bg-gray-50' : "bg-slate-950"} flex items-center justify-center`}>
            ...
            <ToastContainer />
            <p className={`fixed text-sm lg:text-base bottom-2 lg:bottom-5 text-center  ${theme === 'on' ? 'text-black' : "text-white"} `}>Created By Muhammad Shoaib</p>
        </div>
    )
}
